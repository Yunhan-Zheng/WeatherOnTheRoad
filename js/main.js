...
function loadWeather(){
    ...
    // GET THE CONDITIONS
    weatherConditions.open('GET', 'http://api.wunderground.com/api/3f1c9d9507074675/conditions/q/'+zip+'.json', true);
    weatherConditions.responseType = 'text';
    weatherConditions.send(null);
    // GET THE FORECARST
    weatherForecast.open('GET', 'http://api.wunderground.com/api/3f1c9d9507074675/forecast/q/'+zip+'.json', true);
